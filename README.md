...
```
## OUTPUT:
<img width="1685" height="801" alt="image" src="https://github.com/user-attachments/assets/c2c1dc23-db48-4d0d-8d97-9cea1244caf9" />

## RESULT:
Thus the program has been executed by using CUDA to mulptiply two matrices. It is observed that there are variations in host and device elapsed time. Device took 0.000195 time.
